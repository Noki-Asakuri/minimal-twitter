...
const bundle = async (manifest, bundleDirectory) => {
  try {
    ...
    await copy("apps/content-scripts/dist", `${bundleDirectory}/dist`);
    console.log(`🚗  Moved content_scripts to bundle.`);

    // Bundle background.js
    await copyFile("scripts/background.js", `${bundleDirectory}/background.js`);
    console.log(`🚗  Moved background.js to bundle.`);

    // Bundle css
    await copy("assets/css", `${bundleDirectory}/css`);
    ...
    // Bundle images
    await copy("assets/images", `${bundleDirectory}/images`);
