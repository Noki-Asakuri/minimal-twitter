...
function Header() {
  return (
    <header className="px-2 pt-2 pb-5 text-center">
      <div className="relative flex h-9 items-center justify-center">
        <a
          href="https://twitter.com/settings/mute_and_block"
          target="_blank"
          rel="noreferrer"
          className="absolute left-1 grid size-8 place-items-center rounded-lg text-primary transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="absolute right-1 rounded-lg px-2.5 py-1.5 text-sm font-semibold text-primary transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50"
      ...
      <p className="pt-2 text-sm font-medium leading-5 text-muted-foreground">
        Join top creators on{" "}
        <a
          href={createTypefullyUrl({ utm_content: "popup-header-link" })}
          target="_blank"
          rel="noreferrer"
          className="ml-1 cursor-pointer font-bold text-primary underline-offset-4 hover:underline"
        >
          <TypefullyGlyph />
          Typefully
        </a>
